...
Most of these come down to network reality or how coinbase serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

coinbase rate-limits like any public site. coinbase already paces
...
Where a surface is gated, coinbase reads a cookie or token you supply
...
`coinbase`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what coinbase actually did
